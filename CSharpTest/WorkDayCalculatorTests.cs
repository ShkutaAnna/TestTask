...
namespace CSharpTest
{
    ...
    public class WorkDayCalculatorTests
    {
        ...
        [TestMethod]
        public void TestStartDateIsAWeekend()
        {
            DateTime startDate = new DateTime(2019, 4, 21);
            int count = 5;
            WeekEnd[] weekends = new WeekEnd[2]
            {
                new WeekEnd(new DateTime(2019, 4, 21), new DateTime(2019, 4, 25)),
                new WeekEnd(new DateTime(2019, 4, 29), new DateTime(2019, 4, 29))
            };

            DateTime result = new WorkDayCalculator().Calculate(startDate, count, weekends);

            Assert.IsTrue(result.Equals(new DateTime(2019, 5, 1)));
        }
